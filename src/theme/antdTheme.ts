...
export const darkTheme: ThemeConfig = {
  token: {
    ...
    boxShadowTertiary: '0 20px 25px -5px rgba(0, 0, 0, 0.6), 0 10px 10px -5px rgba(0, 0, 0, 0.5)',
  },
  components: {
    Layout: {
    ...
    Card: {
      headerBg: 'linear-gradient(135deg, #1e293b 0%, #334155 100%)',
      colorBgContainer: '#1e293b',
      boxShadowTertiary: '0 10px 15px -3px rgba(0, 0, 0, 0.5), 0 4px 6px -2px rgba(0, 0, 0, 0.4)',
      borderRadius: 16,
